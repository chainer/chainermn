...
# -*- coding: utf-8 -*-
#
# ChainerMN documentation build configuration file, created by
...
project = 'ChainerMN'
copyright = '2017-2018, Preferred Networks, inc.'
...
htmlhelp_basename = 'ChainerMNdoc'
...
latex_documents = [
    (master_doc, 'ChainerMN.tex', 'ChainerMN Documentation',
     'Takuya Akiba', 'manual'),
]
...
man_pages = [
    (master_doc, 'chainermn', 'ChainerMN Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ChainerMN', 'ChainerMN Documentation',
     author, 'ChainerMN', 'One line description of project.',
     'Miscellaneous'),
]
